    ...
    function react_shell_build_bootstrap_payload(array $request, array $appConfig, array $pageTitle)
    {
        ...
        $payload = [
            ...
            'labels' => [
                ...
                'out' => __('Out'),
                'total' => __('Total'),
                'dashboard' => __('Traffic overview'),
                'dashboardDescription' => __('Track your network usage across hours, days and months.'),
                'interfaces' => __('Interfaces'),
                'views' => __('Views'),
                'refresh' => __('Refresh'),
                'refreshing' => __('Refreshing...'),
                'lastFetched' => __('Last fetched'),
                'requestTimeout' => __('The request timed out. Please retry.'),
                'retainedData' => __('Showing the last successfully loaded data.'),
                'sortBy' => __('Sort by'),
                'newestFirst' => __('Newest first'),
                'oldestFirst' => __('Oldest first'),
                'largestFirst' => __('Highest traffic first'),
                'exportCsv' => __('Export CSV'),
                'records' => __('records'),
                'chartHint' => __('Toggle incoming or outgoing traffic. Keep at least one visible.'),
            ],
            'meta' => [
